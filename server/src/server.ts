...
import { getTargetLine, getAllTheModuleFolders, checkIsTrongateProject, getViewFiles, isFalseLine, parseModule, extractFunctions, hasLoadedModule, autoCompele } from './utils/index'
...
connection.onCompletion(
	(_textDocumentPosition: TextDocumentPositionParams): CompletionItem[] => {
		...
		try {
			...
			return autoCompele(_textDocumentPosition, GLOBAL_SETTINGS)
